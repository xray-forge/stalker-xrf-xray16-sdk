...
export {
  ...
  MockCUIFrameLineWnd as CUIFrameLineWnd,
  MockCUIFrameWindow as CUIFrameWindow,
  ...
  MockCUIProgressBar as CUIProgressBar,
  ...
  MockCUIVersionList as CUIVersionList,
  MockCUIWindow as CUIWindow,
  MockUIHint as UIHint,
